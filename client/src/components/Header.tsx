      ...
      >
        ...
        <Transition show={mobileMenuOpen}>
          <Dialog as='div' className='lg:hidden' onClose={setMobileMenuOpen}>
            ...
            >
              <DialogPanel
                className={`fixed inset-y-0 right-0 z-50 w-full sm:max-w-sm overflow-y-auto bg-white sm:ring-1 sm:ring-gray-900/10`}
              >
                  ...
                  <div className='-my-6 divide-y divide-gray-500/10'>
                    <div className='space-y-2 py-6'>
                      {navigation.map((item) => (
                        <div
                          key={item.name}
                          className='block rounded-lg px-0 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50'
                        >
